...
Dr_Mouse_Over_Debuff_Spells = {
    ...
    ["Maim"] = L_DR_Mouse_Over_Text["Incapacitate"],
    ...
    --Unstable Affliction
    ["Unstable Affliction Silence Effect"] = L_DR_Mouse_Over_Text["Unstable Affliction"],
    -- Stun
    ...
    --chastise
    ["Chastise"] = L_DR_Mouse_Over_Text["Chastise"],
    --Counterattack
