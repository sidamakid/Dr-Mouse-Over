...
Dr_Mouse_Over_Spells = {
    ...
    --Kidney Shot
    ["Kidney Shot"] = L_DR_Mouse_Over_Text["Kidney Shot"],
    --Charm
    ["Mind Control"] = L_DR_Mouse_Over_Text["Charm"],
    --Scatter
    ["Scatter Shot"] = L_DR_Mouse_Over_Text["Scatter Shot"],
    -- Stun
    ...
    --Stun Proc
    ["Improved Starfire"] = L_DR_Mouse_Over_Text["Stun Proc"],
    ...
    ["Mace Specialization"] = L_DR_Mouse_Over_Text["Stun Proc"],
    --Sleep
    ["Hibernate"] = L_DR_Mouse_Over_Text["Sleep"],
    --Fear
    ...
    --Horror
    ["Death Coil"] = L_DR_Mouse_Over_Text["None"],
    --Counterattack
    ...
    --Disorient
    ["Blind"] = L_DR_Mouse_Over_Text["None"],
    --Root Proc
    ...
    --Disarm
    ["Disarm"] = L_DR_Mouse_Over_Text["None"],
    ["Riposte"] = L_DR_Mouse_Over_Text["None"],
    --Frost Shock
    ["Frost Shock"] = L_DR_Mouse_Over_Text["Frost Shock"],
}
end