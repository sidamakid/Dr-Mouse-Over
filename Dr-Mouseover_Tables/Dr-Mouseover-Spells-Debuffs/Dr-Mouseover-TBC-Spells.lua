...
Dr_Mouse_Over_Debuff_Spells = {
    ...
    --Stun Proc
    [16922]   = L["Stun Proc"],  -- Celestial Focus (Starfire Stun)
    [19410]   = L["Stun Proc"],  -- Improved Concussive Shot
    [12355]   = L["Stun Proc"],  -- Impact
    [20170]   = L["Stun Proc"],  -- Seal of Justice Stun
    [15269]   = L["Stun Proc"],  -- Blackout
    [18093]   = L["Stun Proc"],  -- Pyroclasm
    [39796]   = L["Stun Proc"],  -- Stoneclaw Stun
    [12798]   = L["Stun Proc"],  -- Revenge Stun
    [5530]    = L["Stun Proc"],  -- Mace Stun Effect (Mace Specialization)
    [15283]   = L["Stun Proc"],  -- Stunning Blow (Weapon Proc)
    [56]      = L["Stun Proc"],  -- Stun (Weapon Proc)
    [34510]   = L["Stun Proc"],  -- Stormherald/Deep Thunder (Weapon Proc)
    --Fear
